...
class SSBModulator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SSBModulator")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/jdtech/Downloads/Jonathan_Rose_Clip.wav', False)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/jdtech/Downloads/Jonathan_Rose_Clip_Modulated.wav',
            1,
            samp_rate,
            blocks.FORMAT_WAV,
            blocks.FORMAT_FLOAT,
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 1, 2900, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=SSBModulator, options=None):
